...
DEFAULT_NODES_PER_LAYER = (10000, 5000, 1000, 500, 10)
USE_SAMPLER = False
...
if __name__ == "__main__":
    ...
    best_model = get_classifer_entrypoint(cleaned_data_filepath, outcomes_filepath, testing_features_filepath, testing_outcomes_filepath)
